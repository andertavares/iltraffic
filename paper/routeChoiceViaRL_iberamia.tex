...
For both ($n$) and ($o$), smaller values means better performance, as less roads are congested and the severity of congestions is lower.
...
%TODO prepare NETLOGO experiments, capture the METRICS
