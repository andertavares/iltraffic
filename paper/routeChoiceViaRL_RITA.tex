...
\begin{figure}[ht]
  ...
  \caption{Box-and-whisker charts showing the effect $\alpha$ on the number of aborted trips \subref{fig:abortedTripsVsAlpha}, the mean trip length \subref{fig:tripLengthVsAlpha} and mean travel time \subref{fig:travelTimeVsAlpha-grid} in the grid scenario.}
...
\begin{figure}[ht]
  \centering
  \subfigure[]{
    \includegraphics[width=5cm]{img/travelTimeVsAlpha-tiny.png}
    \label{fig:travelTimeVsAlpha}
  }
  \subfigure[]{
    \includegraphics[width=5cm]{img/travelTimeVsGamma-tiny.png}
