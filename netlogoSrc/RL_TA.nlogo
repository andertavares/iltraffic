...
globals [ ideal-segment-length ]

to setup 
    clear-all
    read-from-file "mgta2"
    ask roads [
      set shape "default"
      set thickness .2
    ]
    
    create-vehicles num-drivers
    ask vehicles [
      set origin random 3 ;origem em nos 0, 1 ou 2
      set destination 7 + random 3 ;destino em 7, 8 ou 9
    ]
end
...
to read-from-file [ filename ]
  ...
  [
    ...
    [
      create-roads-to intersections with [temp-id = id2]
    ]
  ]
  file-close  
end
